...
const addValues = (arr) => {
  const addValuesInArray = arr.reduce((acc, value) => acc + value, 0);
  return addValuesInArray;
};
...
const addPurchases = (arr) => {
  const totalAmountPurchased = arr.reduce((accumulator, value) => {
...
const countNumberOfElements = (arr) => {
  const countNumberOfElementsInArray = arr.reduce((accumulator) => {
    return accumulator + 1;
  });
  return countNumberOfElementsInArray;
};
...
const returnNames = (arr) => {
  const theRebelScum = arr.reduce((acc, value) => {
    acc.push(value.name);
    return acc;
  }, []);
  return theRebelScum;
...
const reversedString = (str) => {
  ...
  return reversedStringArray.reduce((acc, value) => value + acc, '');
};
